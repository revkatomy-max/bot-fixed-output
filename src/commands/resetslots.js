  ...
  async execute(interaction) {
    ...
    if (target === 'all') {
      ...
      try {
        ...
        const { updateAllDurationChannels } = await import('../utils/durationChannelManager.js');
        await updateAllDurationChannels(interaction.client);
      } catch (e) { logger.warn('updateSlotList/DurationChannels error:', e.message); }
